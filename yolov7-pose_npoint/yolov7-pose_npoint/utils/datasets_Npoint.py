                ...
                if os.path.isfile(lb_file):
                    ...
                    if len(l):
                        ...
                        if kpt_label:
                            ...
                            assert l.shape[1] == 5 + 3 * self.kpt_num, 'labels require 5 + 3* kpt_num columns each'
                            ...
                            #kpts = np.zeros((l.shape[0], 5+ 3 * self.kpt_num))
                            for i in range(len(l)):
                                #remove the occlusion paramater from the GT
                                '''
                                    the ori label is [cls, x1, y1, x2, y2, occlusion, x1, y1, x2, y2, occlusion, ...]
                                    the new label is [cls, x1, y1, x2, y2, x1, y1, x2, y2, ...]
                                '''
                                kpts[i, 0] = l[i, 0]
                                kpts[i, 1] = l[i, 1]
                                kpts[i, 2] = l[i, 2]
